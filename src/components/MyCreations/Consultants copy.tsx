...
export default function ConsultantsPage() {
  ...
  // Updated handleSubmit function to use API route
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Call your own API route instead of n8n directly
  ...
  // Updated handleConsultantClick function
  ...
  // Updated handleHopkinsSynthesis function
          ...
          <div className="lg:col-span-2 flex items-center justify-center">
            <div className="max-w-md mx-auto text-center">
              ...
              {/* Conversation Display */}
                       ...
                       <ScrollArea className="h-[700px] w-[580px] rounded-md border">
        {conversation && (
